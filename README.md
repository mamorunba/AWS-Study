...
- プリケーションコードを「サンプルアプリケーション」を選択し、「さらにオプションを設定」ボタンを押下
...
![image](https://user-images.githubusercontent.com/2520577/42406116-758e65c6-81dc-11e8-96d7-e25f1b5adaca.png)
